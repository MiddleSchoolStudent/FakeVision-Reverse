...
(async () => {
    try {
            ...
            ;[
                ...
                const _0x5030d8 =
                    'cos' == _0x35aaa4
                        ...
                        : 'acos' == _0x35aaa4 || 'asin' == _0x35aaa4 || 'atanh' == _0x35aaa4
                            ? [0.5]
                            : 'pow' == _0x35aaa4 || 'atan2' == _0x35aaa4
                                ? [Math.PI, 2]
                                : [Math.PI],
                    _0xc64f3 = Math[_0x35aaa4](..._0x5030d8),
                    _0x4ff34d = Math[_0x35aaa4](..._0x5030d8)
                    ; (isNaN(_0xc64f3) && isNaN(_0x4ff34d)) ||
                        _0xc64f3 == _0x4ff34d ||
                        ((_0x16b293 = true), __detectResults.Z.setValue('math', '1'))
            })
        const _0x1a8e96 = 0.123,
            _0x5aa53b = 0x1b8ebd078e8c000000000000000000000,
            _0x16627a = [
                [
                    'acos',
                    [_0x1a8e96],
                ...
                ['asin', [_0x1a8e96], 'asin(' + _0x1a8e96 + ')', 0.12331227519187199, NaN, NaN, NaN],
                [
                    'asinh',
                    [
                ...
                ['atan2', [1e-310, 2], 'atan2(1e-310,\x202)', 5e-311, NaN, NaN, NaN],
                ...
                ['cos', [_0x1a8e96], 'cos(' + _0x1a8e96 + ')', 0.9924450321351935, NaN, NaN, NaN],
                ...
                ['exp', [_0x1a8e96], 'exp(' + _0x1a8e96 + ')', 1.1308844209474893, NaN, NaN, NaN],
                ...
                ['log', [_0x1a8e96], 'log(' + _0x1a8e96 + ')', -2.0955709236097197, NaN, NaN, NaN],
                ['log', [Math.PI], 'log(Math.PI)', 1.1447298858494002, NaN, NaN, NaN],
                ['log1p', [_0x1a8e96], 'log1p(' + _0x1a8e96 + ')', 0.11600367575630613, NaN, NaN, NaN],
                ['log1p', [Math.PI], 'log1p(Math.PI)', 1.4210804127942926, NaN, NaN, NaN],
                ['log10', [_0x1a8e96], 'log10(' + _0x1a8e96 + ')', -0.9100948885606021, NaN, NaN, NaN],
                [
                    'log10',
                    [Math.PI],
                    'log10(Math.PI)',
                ...
                ['sqrt', [_0x1a8e96], 'sqrt(' + _0x1a8e96 + ')', 0.3507135583350036, NaN, NaN, NaN],
        ...
        const _0x46c1c2 = {}
        _0x16627a.forEach((_0x42ef78) => {
            _0x46c1c2[_0x42ef78[2]] = (0, __logAndSafeCall.__safeCallFunction)(() => ({
                value: 'polyfill' != _0x42ef78[0] ? Math[_0x42ef78[0]](..._0x42ef78[1]) : _0x42ef78[1],
            }))
        })
        const _0x17b6d8 = {
            data: _0x46c1c2,
            ...
            _0x330238 = yield(0, _0x3c078b.__encodeText)(_0x17b6d8.data)
        return (_0x17b6d8.hash = _0x330238), (_0x17b6d8.computingTime = __timeLogger.stop()), _0x17b6d8
    } catch (_0x27e2f3) {
        return void (0, __logAndSafeCall.captureError)(_0x27e2f3)
    }
})().then(result => {
    debugger;
    console.log(result);
